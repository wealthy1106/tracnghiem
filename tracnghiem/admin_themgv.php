<?php 
  ...
  if(isset($_POST['matk'])){
    ...
    $stmt->execute([
      ...
      $stmt=$pdo->prepare('insert into GIAOVIEN                                           
      (MaGV,TenGV,MaMon)
      values (?,?,?)'); 
    $stmt->execute([
      $_POST['matk'],
    ...
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-9 mt-3 text-center">
              <h3 class=" mt-3 text-center mb-5">Thêm Tài khoản Giáo Viên</h3>
              <form method="post" action="admin_them.php"   >
                <div class="form-group">
                  ...
                  <div class="form-group ">
                  <label for="mon" class="text-left" style="width:150px">Môn dạy</label>
                    
                  <select name="mm" id="mon"style="width:250px" class="py-1">
                      <option value="">--Chọn môn--</option>
                      <option value="CT112" >Mạng Máy Tính</option>
                      <option value="CT179">Quản Trị dữ liệu</option>
                      <option value="ML019">Lịch sử Đảng cộng sản Việt Nam </option>
                  </select>
              </div>
